...
OFF_TURN_SPRITE = 'imgs/dungeon_crawl/misc/out_of_sight_old.png'
OFF_TURN = pg.transform.scale(pg.image.load(OFF_TURN_SPRITE).convert_alpha(), (TILE_SIZE, TILE_SIZE))
OFF_TURN_OPACITY = 40
...
NEW_TURN_TEXT = TITLE_FONT.render("Novo Turno !", 1, WHITE)
...
VICTORY_TEXT = TITLE_FONT.render("VITÓRIA !", 1, WHITE)
...
DEFEAT_TEXT = TITLE_FONT.render("DERROTA !", 1, WHITE)
...
class Level:
    def __init__(self, directory):
        ...
        #Load players
        for player in tree.xpath("/level/players/player"):
