...
class AIBot:
    ...
    def invoke(self, history_messages, question):
        ...
        Você é um assistente especializado na empresa cardeal.
        Tire dúvidas dos possíveis clientes que entrarem em contato.
        Responda de forma natural, agradável, respeitosa e sucinta. Seja objetivo nas respostas, com informações
